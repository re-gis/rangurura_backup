...
public class ProblemServiceImpl implements ProblemService {
    ...
    // @Override
    // public ApiResponse<Object> createAProblem(CreateProblemDto dto) throws
    // Exception {
    // try {
    // // get logged in user
    // // UserResponse user = getLoggedUser.getLoggedUser();
    //
    // if (dto.getCategory() == null || dto.getTarget() == null || dto.getUrwego()
    // == null
    // || dto.getPhoneNumber() == null
    // || (dto.getIkibazo() == null && dto.getRecord() == null)) {
    // throw new BadRequestException(
    // "Vuga ikibazo cyawe byibuze ushyireho urwego, kategori yacyo, aho kigenewe na
    // \'proof\' ubundi wohereze!");
    // }
    //
    ...
    // response.setMessage(
    // "Ikibazo cyawe cyoherejwe kubashinzwe kugikurikirana Tegereza igihe gito
    // uraza gusubizwa!");
    ...
    // throw new InvalidEnumConstantException("Invalid enum constant provided in the
    // request.");
